...
class StatisticsUtilsTest {
    ...
    @Test
    fun getActiveAndCompletedStats_TwoCompletedTask_ThreeActiveTask_returns6040() {
        //when
    ...
    @Test
    fun getActiveAndCompletedStats_NoTasks_returns0_0() {
    ...
    @Test
    fun getActiveAndCompletedStats_null_returns0_0() {
